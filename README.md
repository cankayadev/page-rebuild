...
<!-- habe ich einmal gemacht, im allerersten freecodecamp kurs mit der katzen app: schlag nach! -->
- If there are no errors, display the completed state
<!-- bild anzeigen? transform oder z-index ändern mit js? -->
- Reset the form when the user clicks "Continue" on the completed state
<!-- continue resets over js -->
